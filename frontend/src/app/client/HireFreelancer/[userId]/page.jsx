...
// Dynamic route that pairs with the "Hire me" button on FreelancerProfile
// (which navigates to /client/HireFreelancer/<userId>). The static
// /client/HireFreelancer page exists, but without this dynamic segment
// every hire link 404'd.
export default function HireFreelancerById() {
        ...
        <div className="flex flex-col gap-6 lg:gap-8">
          ...
          <div className="bg-[#5BBB7B0D] py-4 px-2 md:py-5 md:px-6 border border-[#FAFAFA] rounded mt-2">
            <p className="text-primary font-medium text-xs md:text-base">
              Define terms, set payment details, and send the offer.
            </p>
          </div>
          <div className="flex flex-col-reverse lg:flex-row gap-6 md:gap-8">
            <ProjectOverview freelancerUserId={userId} />
            <FreelancerDetail freelancerUserId={userId} />
          </div>
        </div>
      </div>
    </ClientLayout>
