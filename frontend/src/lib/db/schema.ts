import { pgTable, varchar, unique, serial, foreignKey, integer, timestamp, boolean, text, doublePrecision, uniqueIndex, type AnyPgColumn, index, uuid, numeric, date, primaryKey, pgEnum } from "drizzle-orm/pg-core"
...
export const enumJobsStatus = pgEnum("enum_jobs_status", ['draft', 'published', 'paused', 'closed'])
